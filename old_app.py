...
def create_cluster():
    global cluster_creation_status, latest_valid_request_id, clusters_info
    ...
    if cluster_name in clusters_info:
    ...
    clusters_info[cluster_name] = {'cluster_name': cluster_name, 'request_id': request_id}
...
def delete_cluster():
    ...
    playbook_path = '/app/uninstall.yml'
    ansible_command = [
        'ansible-playbook',
        '-i', '/tmp/dynamic_inventory.ini',
        playbook_path,
